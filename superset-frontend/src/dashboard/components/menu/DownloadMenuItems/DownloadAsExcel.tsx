...
export default function DownloadAsExcel({
    ...
    const workspaceTitle = useSelector(
        (state: RootState) => state.drilldown?.workspaceTitle
      ) || "Untitled_Workspace";  
      
      console.log("DownloadAsExcel: workspaceTitle =", workspaceTitle);
